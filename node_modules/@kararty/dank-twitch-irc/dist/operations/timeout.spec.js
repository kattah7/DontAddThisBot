...
describe("./operations/timeout", function () {
    ...
    describe("#timeout()", function () {
        it("should send the correct wire command if no reason is given", async function () {
            ...
            (0, timeout_1.timeout)(client, "pajlada", "weeb123", 120);
        ...
        it("should send the correct wire command if a reason is given", async function () {
            ...
            (0, timeout_1.timeout)(client, "pajlada", "weeb123", 120, "read the rules >(");
            chai_1.assert.deepStrictEqual(data, [
        ...
        it("should validate the given channel name", async function () {
            const { client, clientError, end, data } = (0, helpers_spec_1.fakeConnection)();
            const promise = (0, timeout_1.timeout)(client, "PAJLADA", "weeb123", 120);
            await (0, helpers_spec_1.assertErrorChain)(promise, validation_error_1.ValidationError, 'Channel name "PAJLADA" is invalid/malformed');
            end();
            await clientError;
        ...
        it("should validate the given username", async function () {
            const { client, clientError, end, data } = (0, helpers_spec_1.fakeConnection)();
            const promise = (0, timeout_1.timeout)(client, "pajlada", "WEEB123", 120);
            await (0, helpers_spec_1.assertErrorChain)(promise, validation_error_1.ValidationError, 'Channel name "WEEB123" is invalid/malformed');
            end();
            await clientError;
            chai_1.assert.isEmpty(data);
        });
        it("should not send newlines in the reason", async function () {
            const { client, clientError, end, data } = (0, helpers_spec_1.fakeConnection)();
            const promise = (0, timeout_1.timeout)(client, "pajlada", "weeb123", 120, "Please\r\nread the rules!");
            await (0, helpers_spec_1.assertErrorChain)(promise, validation_error_1.ValidationError, "IRC command may not include \\n or \\r");
            end();
            await clientError;
            chai_1.assert.isEmpty(data);
        });
        it("should resolve on incoming timeout_success", async function () {
            ...
            const promise = (0, timeout_1.timeout)(client, "pajlada", "weeb123", 420, "Please read the rules!");
        ...
        it("should reject on incoming no_permission", async function () {
            const { client, emitAndEnd, clientError } = (0, helpers_spec_1.fakeConnection)();
            const promise = (0, timeout_1.timeout)(client, "forsen", "weeb123", 420, "Please read the rules!");
            const response = "@msg-id=no_permission :tmi.twitch.tv NOTICE #forsen " +
                ":You don't have permission to perform that action.";
            emitAndEnd(response);
            await (0, helpers_spec_1.assertErrorChain)([promise, clientError], timeout_1.UserTimeoutError, "Failed to timeout weeb123 for 7m in #forsen: Bad response message: " +

...
describe("./operations/join", function () {
    describe("#getMods()", function () {
        it("sends the correct wire command", function () {
            ...
            (0, get_mods_vips_1.getMods)(client, "pajlada");
        ...
        it("resolves on incoming no_mods", async function () {
            ...
            const promise = (0, get_mods_vips_1.getMods)(client, "tmijs");
        ...
        it("resolves on incoming room_mods", async function () {
            const { emitAndEnd, client, clientError } = (0, helpers_spec_1.fakeConnection)();
            const promise = (0, get_mods_vips_1.getMods)(client, "randers");
        ...
        it("should fail on timeout of 2000 ms", async function () {
            ...
            // when
            const promise = (0, get_mods_vips_1.getMods)(client, "test");
            // then
            sinon.clock.tick(2000);
            await (0, helpers_spec_1.assertErrorChain)(promise, get_mods_vips_1.GetUsersError, "Failed to get mods of channel test: Timed out after waiting for res" +
                "ponse for 2000 milliseconds", timeout_error_1.TimeoutError, "Timed out after waiting for response for 2000 milliseconds");
            await (0, helpers_spec_1.assertErrorChain)(clientError, get_mods_vips_1.GetUsersError, "Failed to get mods of channel test: Timed out after waiting for res" +
                "ponse for 2000 milliseconds", timeout_error_1.TimeoutError, "Timed out after waiting for response for 2000 milliseconds");
        });
    });
    describe("#getVips()", function () {
        ...
        it("resolves on incoming vips_success", async function () {
            const { emitAndEnd, client, clientError } = (0, helpers_spec_1.fakeConnection)();
            const promise = (0, get_mods_vips_1.getVips)(client, "randers");
        ...
        it("should fail on timeout of 2000 ms", async function () {
            ...
            const { client, clientError } = (0, helpers_spec_1.fakeConnection)();
            // when
            const promise = (0, get_mods_vips_1.getVips)(client, "test");
            // then
            sinon.clock.tick(2000);
            await (0, helpers_spec_1.assertErrorChain)(promise, get_mods_vips_1.GetUsersError, "Failed to get vips of channel test: Timed out after waiting for res" +
                "ponse for 2000 milliseconds", timeout_error_1.TimeoutError, "Timed out after waiting for response for 2000 milliseconds");
            await (0, helpers_spec_1.assertErrorChain)(clientError, get_mods_vips_1.GetUsersError, "Failed to get vips of channel test: Timed out after waiting for res" +
                "ponse for 2000 milliseconds", timeout_error_1.TimeoutError, "Timed out after waiting for response for 2000 milliseconds");
        });
    });

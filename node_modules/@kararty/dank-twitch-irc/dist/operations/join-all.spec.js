...
describe("./operations/join-all", function () {
    describe("#joinAll()", function () {
        it("should send the correct wire command for a single chunk", function () {
            ...
            (0, join_all_1.joinAll)(client, ["pajlada", "randers", "nymn_hs", "forsen"]);
        ...
        it("should send the correct wire command for a multiple chunks", async function () {
            const { client, clientError, emitAndEnd, emit, data } = (0, helpers_spec_1.fakeConnection)();
            ...
            const promise = (0, join_all_1.joinAll)(client, channels);
            ...
            (0, helpers_spec_1.assertErrorChain)(
            // tslint:disable-next-line:no-string-literal
            ...
            await (0, helpers_spec_1.assertErrorChain)(clientError, join_1.JoinError, "Failed to join channel nymn_hs: A response to a command issued later than this command was received", timeout_error_1.TimeoutError, "A response to a command issued later than this command was received");
        });
    });
});

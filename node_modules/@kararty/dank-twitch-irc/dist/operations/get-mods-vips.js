...
async function getModsOrVips(conn, channelName, config) {
    ...
    const responseMsg = (await (0, await_response_1.awaitResponse)(conn, {
        success: (0, conditions_1.matchingNotice)(channelName, [config.msgIdNone, config.msgIdSome]),
        failure: (0, conditions_1.matchingNotice)(channelName, [config.msgIdError]),

...
module.exports = {
    ...
    execute: async (message, args, client) => {
        ...
        let { body: userData2, statusCode2 } = await got(`https://api.steampowered.com/ISteamUserStats/GetNumberOfCurrentPlayers/v0001/?appid=730`, { timeout: 10000, throwHttpErrors: false, responseType: "json" });
        console.log(userData2)
        let { body: userData3, statusCode3 } = await got(`https://api.steampowered.com/ISteamUserStats/GetNumberOfCurrentPlayers/v0001/?appid=570`, { timeout: 10000, throwHttpErrors: false, responseType: "json" });

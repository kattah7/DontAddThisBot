...
module.exports = {
    ...
    execute: async (message, args) => {
        ...
        return { text: `Out of ${[...chatters.broadcaster, ...chatters.moderators, ...chatters.vips, ...chatters.viewers].length} users, ${subArray.length} are subscribed to ${message.channelName} 😴 (${subArray.join(", ")})` };
    },
};